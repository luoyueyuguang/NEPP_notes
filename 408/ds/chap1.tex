...
\begin{center}
\begin{tikzpicture}[>=stealth, font=\scriptsize]
  \node[font=\scriptsize, Navy] at (2.2,2.05){插入前};
...
\begin{tikzpicture}[>=stealth, font=\scriptsize]
  ...
  \node[font=\scriptsize, black!70] at (1.85,-0.3){\texttt{(1) s->next=q\ \ (2) s->prior=p}};
  \node[font=\scriptsize, black!70] at (1.85,-0.8){\texttt{(3) q->prior=s\ \ (4) p->next=s}};
\end{tikzpicture}
\end{center}
\end{conclusion}
