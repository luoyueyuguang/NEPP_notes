...
\node at (-2.1,0) {Q[6]};
\node at (-1.5,1.5) {Q[7]};
\draw[->,red,thick] (2.35,0) arc (0:45:2.35);
\node[red,font=\scriptsize] at (2.6,2.1) {front};
\draw[->,blue,thick] (-2.35,0) arc (180:225:2.35);
\node[blue,font=\scriptsize] at (-2.6,-2.1) {rear};
\end{tikzpicture}
\end{center}
\end{mydef}
