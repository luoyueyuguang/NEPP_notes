...
安全序列检测：Work=(3,3,2)。
$P1$: Need(1,2,2)≤Work(3,3,2)$\to$P1完成，Work=(5,3,2)。
$P3$: Need(0,1,1)≤(5,3,2)$\to$P3完成，Work=(7,4,3)。
$P0$: Need(7,4,3)≤(7,4,3)$\to$P0完成，Work=(7,5,3)。
$P2$: Need(6,0,0)≤(7,5,3)$\to$P2完成，Work=(10,5,5)。
$P4$: Need(4,3,1)≤(10,5,5)$\to$P4完成。
