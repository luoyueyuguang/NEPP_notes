...
\node[draw, rectangle, fill=SoftGray, minimum width=11.0cm, minimum height=0.85cm, rounded corners=2pt] (user) at (0,2.6) {用户态（User Mode）：用户进程 / 应用程序};
\node[draw, rectangle, fill=SoftTeal, minimum width=11.6cm, minimum height=2.0cm, rounded corners=3pt] (kernel) at (0,0.2) {};
\node[font=\scriptsize, text=Navy] at (0,0.95) {\textbf{内核（Kernel）——常驻内存}};
\node[draw, rectangle, fill=SoftBlue, minimum width=2.0cm, minimum height=0.62cm] (m1) at (-4.5,-0.15) {进程管理};
\node[draw, rectangle, fill=SoftBlue, minimum width=2.0cm, minimum height=0.62cm] (m2) at (-2.25,-0.15) {内存管理};
\node[draw, rectangle, fill=SoftBlue, minimum width=2.0cm, minimum height=0.62cm] (m3) at (0,-0.15) {文件管理};
\node[draw, rectangle, fill=SoftBlue, minimum width=2.0cm, minimum height=0.62cm] (m4) at (2.25,-0.15) {设备管理};
\node[draw, rectangle, fill=SoftBlue, minimum width=2.0cm, minimum height=0.62cm] (m5) at (4.5,-0.15) {网络};
\node[draw, rectangle, fill=SoftAmber, minimum width=11.0cm, minimum height=0.85cm, rounded corners=2pt] (hw) at (0,-1.9) {硬件（Hardware）：CPU / 内存 / 设备};
\draw[dashed, RuleGray] (-5.7,1.45) -- (5.7,1.45);
\node[fill=white, font=\scriptsize, text=MutedText, rounded corners=1pt, inner sep=1pt] at (0,1.45) {态切换：系统调用 / 中断 / 异常};
\end{tikzpicture}
\end{center}
