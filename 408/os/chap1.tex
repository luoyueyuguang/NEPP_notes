...
\node[draw, rectangle, fill=SoftBlue, minimum width=4.0cm, minimum height=0.55cm] (m1) at (0,0) {进程管理};
\node[draw, rectangle, fill=SoftBlue, minimum width=4.0cm, minimum height=0.55cm] (m2) at (0,-0.75) {内存管理};
\node[draw, rectangle, fill=SoftBlue, minimum width=4.0cm, minimum height=0.55cm] (m3) at (0,-1.5) {文件系统};
\node[draw, rectangle, fill=SoftBlue, minimum width=4.0cm, minimum height=0.55cm] (m4) at (0,-2.25) {设备驱动};
\node[draw, rectangle, fill=Teal!15, minimum width=4.0cm, minimum height=0.55cm] (m5) at (0,-3.0) {内核态（整体）};
\node[font=\scriptsize] at (0,0.5) {\textbf{大内核}};
\node[draw, rectangle, fill=SoftAmber, minimum width=4.0cm, minimum height=0.55cm] (k1) at (6.4,0) {进程调度 / 进程通信 / 中断};
\node[draw, rectangle, fill=SoftGray, minimum width=4.0cm, minimum height=0.55cm] (k2) at (6.4,-0.9) {文件系统、设备驱动等（用户态服务）};
\node[draw, rectangle, fill=SoftGray, minimum width=4.0cm, minimum height=0.55cm] (k3) at (6.4,-1.8) {其余功能（运行于用户态）};
\node[draw, rectangle, fill=Teal!15, minimum width=4.0cm, minimum height=0.55cm] (k4) at (6.4,-2.7) {内核态（最小核心）};
\node[font=\scriptsize] at (6.4,0.5) {\textbf{微内核}};
\end{tikzpicture}
\end{center}
