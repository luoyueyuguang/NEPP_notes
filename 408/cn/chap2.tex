...
\item \textbf{（真题风格·选择题）} 若将1010 0110用曼彻斯特编码，则第一个比特（最高位1）的编码波形为
\begin{center}
\begin{tabular}{ll}
...
\ifshowsolutions\par\noindent\textbf{解析：} 曼彻斯特编码：1$\to$中间从高到低跳变；0$\to$中间从低到高跳变。第一个比特为1，中间跳变高$\to$低。前半高电平，后半低电平即中间从高到低。\boxed{\textbf{答案：}(A)}\fi
