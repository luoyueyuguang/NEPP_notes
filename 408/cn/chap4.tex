...
\ifshowsolutions\par\noindent\textbf{解析：} /24分出3位子网（掩码248=11111000），子网数$=2^3=8$。每子网$2^5-2=30$个可用地址。等等——/24→子网掩码/29（248），子网位数$=29-24=5$，子网数$=2^5=32$。每子网主机位$=32-29=3$，地址数$=2^3-2=6$。\boxed{\textbf{答案：}(B)}\fi
