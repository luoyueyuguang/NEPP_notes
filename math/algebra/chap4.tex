...
当 \(n - r = 1\) 时，齐次方程组的解空间是过原点的一条直线；非齐次方程组的解集是与之平行、过特解 \(\boldsymbol{\eta}^*\) 的一条直线（\(A\boldsymbol{x} = \boldsymbol{b}\) 的解集是 \(\boldsymbol{\eta}^* + \ker(A)\)）：
\begin{center}
\begin{tikzpicture}
\begin{axis}[
  width=0.30\linewidth, height=4.5cm,
  view={70}{28},
  xmin=-1.5, xmax=1.5, ymin=-1.5, ymax=1.5, zmin=-1.5, zmax=1.5,
  xlabel={$x$}, ylabel={$y$}, zlabel={$z$}, font=\footnotesize,
  axis lines=box, xtick=\empty, ytick=\empty, ztick=\empty, z buffer=sort,
  title={\textcolor{blue}{唯一解（三平面交于一点）}}]
\addplot3[fill=blue!18,fill opacity=0.5,draw=blue!70,thick] coordinates {(0.4,-1.5,-1.5) (0.4,1.5,-1.5) (0.4,1.5,1.5) (0.4,-1.5,1.5)};
\addplot3[fill=green!22,fill opacity=0.5,draw=green!40!black,thick] coordinates {(-1.5,0.3,-1.5) (1.5,0.3,-1.5) (1.5,0.3,1.5) (-1.5,0.3,1.5)};
\addplot3[fill=orange!22,fill opacity=0.5,draw=orange,thick] coordinates {(-1.5,-1.5,0.6) (1.5,-1.5,0.6) (1.5,1.5,0.6) (-1.5,1.5,0.6)};
\node[circle,fill=red,inner sep=3.4pt,label={[font=\footnotesize,anchor=south east]left:$P$}] at (axis cs:0.4,0.3,0.6) {};
\end{axis}
\end{tikzpicture}
\hspace{0.10cm}
\begin{tikzpicture}
\begin{axis}[
  ...
  xlabel={$x$}, ylabel={$y$}, zlabel={$z$}, font=\footnotesize,
  axis lines=box, xtick=\empty, ytick=\empty, ztick=\empty, z buffer=sort,
  title={\textcolor{blue}{无穷多解（三平面交于一线）}}]
\addplot3[fill=blue!18,fill opacity=0.5,draw=blue!70,thick] coordinates {(0.4,-1.5,-1.5) (0.4,1.5,-1.5) (0.4,1.5,1.5) (0.4,-1.5,1.5)};
\addplot3[fill=green!22,fill opacity=0.5,draw=green!40!black,thick] coordinates {(-1.5,0.3,-1.5) (1.5,0.3,-1.5) (1.5,0.3,1.5) (-1.5,0.3,1.5)};
\addplot3[fill=orange!22,fill opacity=0.5,draw=orange,thick] coordinates {(1.5,-0.8,-1.5) (1.5,-0.8,1.5) (-0.8,1.5,1.5) (-0.8,1.5,-1.5)};
\draw[red,very thick] (axis cs:0.4,0.3,-1.5) -- (axis cs:0.4,0.3,1.5);
\end{axis}
\end{tikzpicture}
\hspace{0.10cm}
\begin{tikzpicture}
\begin{axis}[
  ...
  xlabel={$x$}, ylabel={$y$}, zlabel={$z$}, font=\footnotesize,
  axis lines=box, xtick=\empty, ytick=\empty, ztick=\empty, z buffer=sort,
  title={\textcolor{blue}{无解（三平面无公共交点）}}]
\addplot3[fill=blue!18,fill opacity=0.5,draw=blue!70,thick] coordinates {(0.4,-1.5,-1.5) (0.4,1.5,-1.5) (0.4,1.5,1.5) (0.4,-1.5,1.5)};
\addplot3[fill=green!22,fill opacity=0.5,draw=green!40!black,thick] coordinates {(-1.5,0.3,-1.5) (1.5,0.3,-1.5) (1.5,0.3,1.5) (-1.5,0.3,1.5)};
\addplot3[fill=orange!22,fill opacity=0.5,draw=orange,thick] coordinates {(1.5,-0.5,-1.5) (1.5,-0.5,1.5) (-0.5,1.5,1.5) (-0.5,1.5,-1.5)};
\draw[gray,dashed,thick] (axis cs:0.4,0.3,-1.5) -- (axis cs:0.4,0.3,1.5);
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{center}
\footnotesize
三个方程 \(Ax=b\)（\(x\in\mathbb{R}^3\)）对应三张平面。左图：平面 \(x=0.4\)、\(y=0.3\)、\(z=0.6\) 交于唯一一点 \((0.4,0.3,0.6)\)（红点 \(\boldsymbol P\)），方程组有\textbf{唯一解}；中图：三平面同过竖直线 \(x=0.4,\,y=0.3\)（红线），方程组有\textbf{无穷多解}；右图：平面 \(x=0.4\) 与 \(y=0.3\) 交成竖直线（灰虚线），但平面 \(x+y=1\) 与该竖直线平行（\(0.4+0.3=0.7\neq1\)）而不经过它，三平面\textbf{无公共交点}，方程组\textbf{无解}。
\end{center}
...
二维情形：若 \(A\) 的列向量均共线，则 \(\operatorname{Col}(A)\) 是过原点的一条直线；当 \(b\) 不落在该直线上时，方程组 \(A\boldsymbol{x} = \boldsymbol{b}\) 无解：
\begin{center}
\begin{tikzpicture}
\begin{axis}[
  axis lines=center,
  width=0.78\linewidth, height=5.8cm,
  xlabel={$x_1$}, ylabel={$x_2$},
  xmin=-1.2, xmax=5.2, ymin=-1.2, ymax=5.2,
  xtick={1,2,3,4}, ytick={1,2,3,4},
  font=\footnotesize,
]
\draw[blue,thick] (axis cs:-0.6,-0.6) -- (axis cs:4.6,4.6);
\draw[->,thick,blue] (axis cs:0,0) -- (axis cs:2,2);
\draw[->,thick,red] (axis cs:0,0) -- (axis cs:1,4);
\node[blue,anchor=south east] at (axis cs:2,2) {$\boldsymbol{\alpha}_1$};
\node[red,anchor=south west] at (axis cs:1,4) {$\boldsymbol{b}$};
\node[blue] at (axis cs:3.9,3.0) {$\operatorname{Col}(A)$};
\node[red] at (axis cs:2.4,4.35) {$\boldsymbol{b}\notin\operatorname{Col}(A)$，无解};
\end{axis}
\end{tikzpicture}
\end{center}
...
在 \(\mathbb{R}^2\) 中，行空间 \(\operatorname{Row}(A)\) 是过原点的一条直线，零空间 \(\ker(A)\) 是与它\textbf{正交}的过原点的直线（\(\ker(A) = (\operatorname{Row}(A))^\perp\)）：
\begin{center}
\begin{tikzpicture}
\begin{axis}[
  axis lines=center,
  ...
  xtick={-3,-1,1,3}, ytick={-3,-1,1,3},
  font=\footnotesize,
]
\draw[blue,thick] (axis cs:-3.6,-1.8) -- (axis cs:3.6,1.8);
\draw[red,thick] (axis cs:-1.8,3.6) -- (axis cs:1.8,-3.6);
\node[blue,anchor=south] at (axis cs:3.4,1.7) {$\operatorname{Row}(A)$};
\node[red,anchor=north] at (axis cs:1.7,-3.4) {$\ker(A)$};
\draw[black,thick] (axis cs:0.447,0.224) -- (axis cs:0.224,0.670) -- (axis cs:-0.224,0.447);
\end{axis}
\end{tikzpicture}
\end{center}
