...
\begin{tikzpicture}
\begin{axis}[
  width=0.30\linewidth, height=4.3cm,
  view={115}{30},
  xmin=-1.9, xmax=1.9, ymin=-1.9, ymax=1.9, zmin=-1.9, zmax=1.9,
  xlabel={$x$}, ylabel={$y$}, zlabel={$z$}, font=\footnotesize,
  axis lines=center, tick style={draw=none}, z buffer=sort,
  title={\textcolor{blue}{唯一解（三平面交于一点）}},
]
\addplot3[fill=blue!18,fill opacity=0.6,draw=blue!70,thick] coordinates {(0.4,-1.9,-1.9) (0.4,1.9,-1.9) (0.4,1.9,1.9) (0.4,-1.9,1.9)};
\addplot3[fill=green!25,fill opacity=0.6,draw=green!40!black,thick] coordinates {(-1.9,0.3,-1.9) (1.9,0.3,-1.9) (1.9,0.3,1.9) (-1.9,0.3,1.9)};
\addplot3[fill=orange!25,fill opacity=0.6,draw=orange,thick] coordinates {(-1.9,-1.9,0.6) (1.9,-1.9,0.6) (1.9,1.9,0.6) (-1.9,1.9,0.6)};
\fill[red] (axis cs:0.4,0.3,0.6) circle (2.6pt);
\end{axis}
\end{tikzpicture}
\hspace{0.08cm}
\begin{tikzpicture}
...
\addplot3[fill=blue!18,fill opacity=0.6,draw=blue!70,thick] coordinates {(0.4,-1.9,-1.9) (0.4,1.9,-1.9) (0.4,1.9,1.9) (0.4,-1.9,1.9)};
\addplot3[fill=green!25,fill opacity=0.6,draw=green!40!black,thick] coordinates {(-1.9,0.3,-1.9) (1.9,0.3,-1.9) (1.9,0.3,1.9) (-1.9,0.3,1.9)};
\addplot3[fill=orange!25,fill opacity=0.6,draw=orange,thick] coordinates {(1.9,-1.2,-1.9) (1.9,-1.2,1.9) (-1.2,1.9,1.9) (-1.2,1.9,-1.9)};
\draw[very thick,red] (axis cs:0.4,0.3,-1.9) -- (axis cs:0.4,0.3,1.9);
\end{axis}
\end{tikzpicture}
\hspace{0.08cm}
\begin{tikzpicture}
...
\addplot3[fill=blue!18,fill opacity=0.6,draw=blue!70,thick] coordinates {(0.4,-1.9,-1.9) (0.4,1.9,-1.9) (0.4,1.9,1.9) (0.4,-1.9,1.9)};
\addplot3[fill=green!25,fill opacity=0.6,draw=green!40!black,thick] coordinates {(1.9,-0.9,-1.9) (1.9,-0.9,1.9) (-0.9,1.9,1.9) (-0.9,1.9,-1.9)};
\addplot3[fill=orange!25,fill opacity=0.6,draw=orange,thick] coordinates {(-1.9,0.3,-1.9) (1.9,0.3,-1.9) (1.9,0.3,1.9) (-1.9,0.3,1.9)};
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{center}
\footnotesize
三个方程 \(Ax=b\)（\(x\in\mathbb{R}^3\)）对应三张平面。左图：三平面交于唯一一点 \((0.4,0.3,0.6)\)（红点），方程组有\textbf{唯一解}；中图：三平面同过一条竖直线，方程组有\textbf{无穷多解}；右图：平面 \(x=0.4\) 与 \(y=0.3\) 交成一条竖直线，但平面 \(x+y=1\) 与该竖直线平行（\(0.4+0.3=0.7\neq1\)），三平面\textbf{无公共交点}，方程组\textbf{无解}。
\end{center}
