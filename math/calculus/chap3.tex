...
\begin{axis}[width=0.82\linewidth, height=5.4cm,
  ...
  domain=1:8, samples=160, font=\footnotesize,
...
\node[font=\scriptsize,red!70!black,anchor=west] at (axis cs:5.4,0.44){$p=\frac{1}{2}$};
\node[font=\scriptsize,blue!70!black,anchor=west] at (axis cs:5.4,0.185){$p=1$};
\node[font=\scriptsize,green!55!black,anchor=west] at (axis cs:5.4,0.035){$p=2$};
\end{axis}
\end{tikzpicture}
\end{center}
